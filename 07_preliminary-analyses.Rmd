...
s1 <- ggplot(trait_data1, aes(y = predawn_MPa, x = DBH_complete, color = species)) +
...
s2 <- ggplot(trait_data1, aes(x = DBH_complete, y = midday_MPa, color = species)) +
  geom_point(size = 3, alpha = 1) +  
...
s3 <- ggplot(trait_data1, aes(x = DBH_complete, y = P50_MPa, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE, alpha = 0.3) +  
  scale_color_manual(values = c(
    "ABCO" = "mediumturquoise",
...
s4 <- ggplot(trait_data1, aes(x = DBH_complete, y = HSM_predawn_P50_mean, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE, alpha = 0.3) +  
  scale_color_manual(values = c(
    "ABCO" = "mediumturquoise",
...
s5 <- ggplot(trait_data1, aes(x = DBH_complete, y = HSM_midday_P50_mean, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE, alpha = 0.3) +  
  scale_color_manual(values = c(
    "ABCO" = "mediumturquoise",
...
e2 <- ggplot(subset(trait_data1, species != "ABMA"), aes(x = elev_indiv, y = HSM_midday_P50_mean, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE,  alpha = 0.25) +
  labs(
    x = "Elevation (ft)", 
...
e3 <- ggplot(
  subset(trait_data1, species != "ABMA" & plot %in% 3:11),
  aes(x = elev_indiv, y = predawn_MPa, color = species)
) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE, alpha = 0.25) +
  labs(
...
mod <- lmer(HSM_midday_P50_mean ~ elev_indiv_scaled + predawn_scaled + percent_closure_scaled + DBH_complete_scaled+ (1 | plot), data = ABCO)
summary(mod)
