...
scale_linetype_manual(values = c(
  ...
  labs(x = "Diameter at root collar (cm)",
...
Fig2A <- ggplot() +
  geom_point(data = trait_data1,
             ...
             alpha = 00.35, size = 2.5, na.rm = TRUE) +
  scale_color_manual(values = species_colors) +
  new_scale_color() +
  geom_line(
  data = all_preds_P50,
...
Fig2B <- ggplot() +
  ...
  geom_line(data = all_preds,
            aes(x = predawn, y = pred, color = species, linetype = signif, alpha = signif),
            size = 1.2, na.rm = TRUE) +
  scale_color_manual(values = species_colors) +
  new_scale_color() +
  scale_color_manual(values = species_colors) +
...
scale_alpha_manual(values = c(
  ...
  labs(x = "Predawn Water Potential (-MPa)",
       y = expression(P[50]~"(MPa)"))   +
  theme(
    panel.background = element_rect(fill = "white", color = NA),
    panel.border = element_rect(color = "gray50", fill = NA, size = 1),  # ← this creates the box
...
Fig2C <- ggplot() +
  geom_point(data = trait_data1,
             ...
             alpha = 00.35, size = 2.5, na.rm = TRUE) +
  geom_line(data = all_preds,
            aes(x = percent_cover, y = pred, color = species, linetype = signif, alpha = signif),
            size = 1.2, na.rm = TRUE) +
  scale_color_manual(values = species_colors) +
  new_scale_color() +
  scale_color_manual(values = species_colors) +
...
Fig2D <- ggplot() +
  ...
  geom_line(data = all_preds_elev_P50,
            aes(x = elevation, y = pred, color = species, linetype = signif, alpha = signif),
            size = 1.2, na.rm = TRUE) +
  scale_color_manual(values = species_colors) +  
  scale_linetype_manual(values = c(
    "Significant"     = "solid",
