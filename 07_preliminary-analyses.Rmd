...
# P50
```{r}
ggplot(yuba_phys_P50_2024, aes(x = size_class, y = P50_MPa, fill = species)) + geom_boxplot(position = position_dodge(0.8), outlier.shape = NA) +  
  labs(x = "Elevation",
       y = "P50 (-MPa)",
       fill = "Species") +
  #scale_y_reverse() +  # Reverse the y-axis
...
mod7<- lmer(PILA$midday_MPa~ DBH_complete + percent_cover +DBH_complete:percent_cover + (1|plot), REML = TRUE, data = PILA)
summary(mod7)
