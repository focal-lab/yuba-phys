...
s3 <- ggplot(trait_data1, aes(x = diameter_complete, y = P50_mean, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE, alpha = 0.3) +  
  scale_color_manual(values = c(
    "ABCO" = "mediumturquoise",
...
r2 <- ggplot(trait_data1, aes(y = P50_mean, x = predawn_MPa_combined, color = species)) +
  geom_point(size = 3, alpha = 1) +
  geom_smooth(method = "lm", se = TRUE, alpha = 0.2, linewidth = 1) +  
  labs(
    x = "Predawn Water Potential (-MPa)",
...
m1 <- ggplot(trait_data1, aes(x = percent_cover, y = P50_combined, color = species)) +
  geom_point(size = 3, alpha = 1) +  
...
m2 <- ggplot(trait_data1, aes(x = percent_cover, y = HSM_midday_P50_mean, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE,  alpha = 0.25) +
  labs(
    x = "Canopy closure (%)", 
...
e1 <- ggplot(subset(trait_data1, species != "ABMA"), aes(x = elev_indiv, y = HSM_midday_P50_mean, color = species))+
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE,  alpha = 0.25) +
  labs(
    x = "Elevation (ft)", 
...
e2 <- ggplot(subset(trait_data1, species != "ABMA"), aes(x = elev_indiv, y = P50_mean, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE,  alpha = 0.25) +
  labs(
    x = "Elevation (ft)", 
...
g1 <- ggplot(trait_data1, aes(x = diameter_complete, y = internode_length_1_2, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE, alpha = 0.3) +  
  scale_color_manual(values = c(
    "ABCO" = "mediumturquoise",
...
g4 <- ggplot(trait_data1, aes(x = P50_mean, y = internode_length_1_2, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE, alpha = 0.3) +  
  scale_color_manual(values = c(
    "ABCO" = "mediumturquoise",
...
g6 <- ggplot(trait_data1, aes(x = elev_indiv, y = internode_length_1_2, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE, alpha = 0.3) +  
  scale_color_manual(values = c(
    "ABCO" = "mediumturquoise",
