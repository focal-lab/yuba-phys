...
s3 <- ggplot(trait_data1, aes(x = diameter_complete, y = P50_combined, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE, alpha = 0.3) +  
  scale_color_manual(values = c(
    "ABCO" = "mediumturquoise",
...
h1 <- ggplot(data = subset(trait_data3),
  ...
  scale_color_manual(values = c(
    "P50_combined" = "blue",
    "P50_mean" = "darkblue",
    "midday_MPa_combined" = "darkcyan",
    "predawn_MPa_combined" = "steelblue3"
  )) +
  theme_bw() +
  labs(
    x = "Diameter at root collar (cm)",
...
h2 <- ggplot(data = subset(trait_data3),
...
h3 <- ggplot(data = subset(trait_data3), 
