...
s1 <- ggplot(trait_data1, aes(y = predawn_MPa_2025, x = diameter_complete, color = species)) +
...
s2 <- ggplot(trait_data1, aes(x = diameter_complete, y = midday_MPa_2025, color = species)) +
  geom_point(size = 3, alpha = 1) +  
...
s3 <- ggplot(trait_data1, aes(x = diameter_complete, y = P50_MPa, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE, alpha = 0.3) +  
  scale_color_manual(values = c(
    "ABCO" = "mediumturquoise",
...
s4 <- ggplot(trait_data1, aes(x = diameter_complete, y = HSM_predawn_P50_mean_2025, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE, alpha = 0.3) +  
  scale_color_manual(values = c(
    "ABCO" = "mediumturquoise",
...
s5 <- ggplot(trait_data1, aes(x = diameter_complete, y = HSM_midday_P50_mean_2025, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE, alpha = 0.3) +  
  scale_color_manual(values = c(
    "ABCO" = "mediumturquoise",
...
r1 <- ggplot(trait_data1, aes(y = HSM_midday_P50_mean_2024, x = predawn_MPa_2024, color = species)) +
  geom_point(size = 3, alpha = 1) +
  geom_smooth(method = "lm", se = TRUE, alpha = 0.2, linewidth = 1) +  
  labs(
...
r2 <- ggplot(trait_data1, aes(y = P50_complete, x = predawn_MPa_2025, color = species)) +
  geom_point(size = 3, alpha = 1) +
  geom_smooth(method = "lm", se = TRUE, alpha = 0.2, linewidth = 1) +  
  labs(
    x = "Predawn Water Potential (-MPa)",
...
m2 <- ggplot(trait_data1, aes(x = percent_cover, y = HSM_midday_P50_mean_2025, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE,  alpha = 0.25) +
  labs(
    x = "Canopy closure (%)", 
...
e1 <- ggplot(subset(trait_data1, species != "ABMA"), aes(x = elev_indiv, y = HSM_midday_P50_mean_2025, color = species))+
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE,  alpha = 0.25) +
  labs(
    x = "Elevation (ft)", 
...
e2 <- ggplot(subset(trait_data1, species != "ABMA"), aes(x = elev_indiv, y = HSM_midday_P50_mean_2025, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE,  alpha = 0.25) +
  labs(
    x = "Elevation (ft)", 
...
g2 <- ggplot(trait_data1, aes(x = predawn_MPa_2025, y = internode_length_1_2, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE, alpha = 0.3) +  
  scale_color_manual(values = c(
    "ABCO" = "mediumturquoise",
...
g3 <- ggplot(trait_data1, aes(x =HSM_midday_P50_mean_2024 , y = trait_data1$internode_length_0_1, color = species)) +
  geom_point(size = 3, alpha = 1) +
  geom_smooth(method = "lm", se = TRUE, alpha = 0.2, linewidth = 1) +  
  labs(
    x = "HSM midday (-MPa)",
...
g4 <- ggplot(trait_data1, aes(x = P50_MPa, y = internode_length_1_2, color = species)) +
  geom_point(size = 3, alpha = 1) +  
  geom_smooth(method = "lm", se = TRUE, alpha = 0.3) +  
  scale_color_manual(values = c(
    "ABCO" = "mediumturquoise",
