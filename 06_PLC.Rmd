...
stemID <- subset(vc_all2, vc_all2$tree =="5014")
...
# Fit the model using only rows where plc_new >= 0
pfit <- fitplcs(PILA_low_sun_seedling, "tree", varnames = c(PLC = "plc_new", WP = "mpa"), nboot = 50)
...
# Fit the model using only rows where plc_new >= 0
pfit <- fitplcs(PIPO_low_sun_seedling, "tree", varnames = c(PLC = "plc_new", WP = "mpa"), nboot = 50)
...
pfit_all <- fitplcs(vc_all_good, "tree",
