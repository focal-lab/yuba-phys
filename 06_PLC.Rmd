...
PILA_low_shade_seedling_cleaned <- 
  PILA_low_shade_seedling %>%  filter(!row_number() %in% c(4, 7, 8, 9, 12, 19, 26, 27, 29, 30, 31, 66, 67, 70, 74, 89, 91, 105, 106, 108, 109, 110))
...
PILA_low_shade_sapling_cleaned <- 
  PILA_low_shade_sapling %>%  filter(!row_number() %in% c(8, 165, 166, 168))
...
PILA_high_shade_seedling_cleaned <- 
  PILA_high_shade_seedling %>%  filter(!row_number() %in% c(1, 2, 3, 4, 5, 8, 9, 10, 11, 23, 42, 45, 46))
...
PILA_high_sun_sapling_cleaned <- 
  PILA_high_sun_sapling %>%  filter(!row_number() %in% c(40,42, 74, 77, 80, 81))
...
PILA_high_shade_sapling_cleaned <- 
  PILA_high_shade_sapling %>%  filter(!row_number() %in% c(1,2, 17, 22, 24, 29, 31, 32, 33, 36, 38))
...
PIPO_low_shade_sapling_cleaned <- 
  PIPO_low_shade_sapling %>%  filter(!row_number() %in% c(3, 23))
...
PIPO_high_sun_seedling_cleaned <- 
  PIPO_high_sun_seedling %>%  filter(!row_number() %in% c(8))
...
ABMA_high_shade_seedling_cleaned <- 
  ABMA_high_shade_seedling %>%  filter(!row_number() %in% c(2, 3, 8, 11, 14, 15, 16, 18, 19, 21, 22, 23, 24, 26, 28, 29, 30, 33, 34, 38, 42, 43, 45, 46, 47))
...
ABMA_high_sun_sapling_cleaned <- 
  ABMA_high_sun_sapling %>%  filter(!row_number() %in% c(2, 8,9, 24, 25, 36, 39, 48, 50))
...
trait_data1 <- trait_data1 %>%
  mutate(P50_mean = case_when(
    size == "seedling" & microsite == "sun"   & species == "ABCO" & elevation == "high" ~ -3.5,
    size == "seedling" & microsite == "shade" & species == "ABCO" & elevation == "high" ~ -3.8,
    size == "seedling" & microsite == "sun"   & species == "ABCO" & elevation == "low" ~ -3.5,
    size == "seedling" & microsite == "shade" & species == "ABCO" & elevation == "low" ~ -3.8,
    size == "sapling" & microsite == "sun"   & species == "ABCO" & elevation == "high" ~ -3.5,
    size == "sapling" & microsite == "shade" & species == "ABCO" & elevation == "high" ~ -3.8,
    size == "sapling" & microsite == "sun"   & species == "ABCO" & elevation == "low" ~ -3.5,
    size == "sapling" & microsite == "shade" & species == "ABCO" & elevation == "low" ~ -3.8,
    
    size == "seedling" & microsite == "sun"   & species == "PILA" & elevation == "high" ~ -3.99,
    size == "seedling" & microsite == "shade" & species == "PILA" & elevation == "high" ~ -3.34,
    size == "seedling" & microsite == "sun"   & species == "PILA" & elevation == "low" ~ -3.94,
    size == "seedling" & microsite == "shade" & species == "PILA" & elevation == "low" ~ -3.31,
    size == "sapling" & microsite == "sun"   & species == "PILA" & elevation == "high" ~ -3.48,
    size == "sapling" & microsite == "shade" & species == "PILA" & elevation == "high" ~ -3.36,
    size == "sapling" & microsite == "sun"   & species == "PILA" & elevation == "low" ~ -4.03,
    size == "sapling" & microsite == "shade" & species == "PILA" & elevation == "low" ~ -3.8,
    
    size == "seedling" & microsite == "sun"   & species == "PIPO" & elevation == "high" ~ -3.5,
    size == "seedling" & microsite == "shade" & species == "PIPO" & elevation == "high" ~ -3.8,
    size == "seedling" & microsite == "sun"   & species == "PIPO" & elevation == "low" ~ -3.5,
    size == "seedling" & microsite == "shade" & species == "PIPO" & elevation == "low" ~ -3.8,
    size == "sapling" & microsite == "sun"   & species == "PIPO" & elevation == "high" ~ -3.5,
    size == "sapling" & microsite == "shade" & species == "PIPO" & elevation == "high" ~ -3.8,
    size == "sapling" & microsite == "sun"   & species == "PIPO" & elevation == "low" ~ -3.5,
    size == "sapling" & microsite == "shade" & species == "PIPO" & elevation == "low" ~ -3.8,
    
    size == "seedling" & microsite == "sun"   & species == "ABMA" & elevation == "high" ~ -3.5,
    size == "seedling" & microsite == "shade" & species == "ABMA" & elevation == "high" ~ -3.8,
    size == "sapling" & microsite == "sun"   & species == "ABMA" & elevation == "high" ~ -4.2,
    size == "sapling" & microsite == "shade" & species == "ABMA" & elevation == "high" ~ -4.3,
