...
stemID <- subset(vc_all2, vc_all2$tree =="254.1")
...
ggplot(yuba_phys_P50_2024, aes(x = elevation, y = P50_MPa, fill = species)) +
  geom_boxplot() +
  labs(
    x = "Elevation",
    y = "P50"
...
ggplot(yuba_phys_P50_2024, aes(x = elev_band_ft, y = P50_MPa, color = species)) +
...
plot(yuba_phys_P50_2024$P50_MPa~yuba_phys_P50_2024$elev_band_ft)
